...
            <h1 class="text-4xl title-font text-orange-500 mb-2">:feet: TF家族缘分指数测试</h1>
...
                </div>
                <div>
                    <label class="block text-sm font-bold text-orange-500 mb-2 ml-1">:orange_heart: 请输入你的出生日期</label>
...
                <div id="userHeader" class="text-2xl font-bold text-gray-700"></div>[22:20]<div id="userSub" class="text-xs text-orange-400 mt-2 font-medium"></div>
            </div>
...
            { name: "张泽禹", xiu: "氐", sun: "金牛", moon: "天秤", zod: "猪", gen: "三代" },
...
            // 五代及其他
            { name: "张重晟", xiu: "毕", sun: "金牛", moon: "射手", zod: "牛", gen: "五代" },[22:20]{ name: "徐子恒", xiu: "心", sun: "射手", moon: "处女", zod: "虎", gen: "五代" },
...
                    "猪": { trine: ["羊", "兔"], hex: "虎", clash: ["蛇", "猴"] }[22:20]};
                const rel = zodiacRel[uZod];
                if (rel.trine.includes(mem.zod)) weight += 4.5; // 三合
                if (rel.hex === mem.zod) weight += 5.5;       // 六合
                if (rel.clash.includes(mem.zod)) weight -= 6.0; // 冲/害
...
                // 插入阶段标题
                if (i === 0) container.insertAdjacentHTML('afterbegin', '<p class="text-[10px] text-orange-400 font-bold mb-2 ml-1 mt-4 tracking-widest">:gem: 命中注定天选区</p>');
                if (i === results.length - 5) {
                    const l = document.createElement('p');
                    l.className = "text-[10px] text-gray-400 font-bold mb-2 mt-8 ml-1 tracking-widest";
                    l.innerText = ":tornado: 磁场冲突警戒区";
                    container.insertBefore(l, card);
                }
            });
...
            const s = ["摩羯","水瓶","双鱼","白羊","金牛","双子","巨蟹","狮子","处女","天秤","天蝎","射手","摩羯"];
